...
export const hrCertificatesRegistry: HrCertificateRow[] = [
  { id: "1", employeeName: "Елена Волкова", department: "Платформа", title: "AWS Solutions Architect Associate", issuer: "Amazon Web Services", issuedAt: "12.11.2025", expiresAt: "12.11.2028", credentialId: "AWS-SAA-99201", status: "Действует" },
  ...
  { id: "3", employeeName: "Ольга Сидорова", department: "Контроль качества", title: "ISTQB Advanced Level Test Analyst", issuer: "ISTQB", issuedAt: "20.06.2025", expiresAt: "20.06.2028", credentialId: "ISTQB-AT-7712", status: "Истекает" },
  { id: "4", employeeName: "Игорь Никифоров", department: "Девопс / инфраструктура", title: "Terraform Associate", issuer: "HashiCorp", issuedAt: "03.04.2025", expiresAt: "03.04.2027", credentialId: "HCP-TF-22091", status: "Действует" },
  ...
  { id: "6", employeeName: "Светлана Морозова", department: "Кадры и персонал", title: "Корпоративная ИБ и персональные данные", issuer: "Алроса ИТ · ЕСО", issuedAt: "15.12.2025", expiresAt: "15.12.2028", credentialId: "ALROSA-SEC-2025-88421", status: "Действует" },
  ...
  { id: "10", employeeName: "Артём Васильев", department: "Дизайн и UX", title: "Google UX Design", issuer: "Coursera / Google", issuedAt: "02.01.2024", expiresAt: "—", credentialId: "G-UX-2024-112", status: "Архив" },
...
/** Сертификаты сотрудника из демо-реестра (для карточек «Команда» и блока в ЛК). */
export function getRegistryCertificatesByEmployeeName(employeeName: string): HrCertificateRow[] {
  return hrCertificatesRegistry.filter((r) => r.employeeName === employeeName);
}
