...
export const adminUsersCatalog: AdminUserRow[] = [
  ...
  { id: "2", name: "Смирнова Анна Павловна", email: "a.smirnova@company.ru", role: "L&D Директор", department: "Обучение", status: "Активен", lastLogin: "30.03.2026 09:18" },
  ...
  { id: "4", name: "Волкова Елена Викторовна", email: "e.volkova@company.ru", role: "Руководитель", department: "Platform", status: "Активен", lastLogin: "30.03.2026 08:02" },
  ...
  { id: "6", name: "Никифоров Игорь Олегович", email: "i.nikiforov@company.ru", role: "Сотрудник", department: "DevOps", status: "Активен", lastLogin: "30.03.2026 07:15" },
