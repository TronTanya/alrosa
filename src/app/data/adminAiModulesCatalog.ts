...
export const adminAiModulesSeed: AdminAiModuleRow[] = [
  {
    ...
    modelLabel: "GigaChat Pro · enterprise",
    latencyMs: 780,
    requestsToday: 1840,
    quotaPct: 42,
    status: "active",
  ...
  {
    id: "ai-hr-mentor",
    name: "ИИ-Наставник HR",
    category: "chat",
    purpose: "Чат куратора L&D, подсказки по заявкам",
    modelLabel: "GigaChat Pro · enterprise",
    latencyMs: 920,
    requestsToday: 612,
    quotaPct: 38,
  ...
  },
  {
    ...
    modelLabel: "Коллаборативная модель + GigaChat",
    latencyMs: 210,
    requestsToday: 3400,
    quotaPct: 33,
    status: "active",
