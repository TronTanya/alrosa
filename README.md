...
| Сложность отследить ИПР и согласования | Выделенные разделы заявок, траекторий и отчётности; уведомления в шапке. |
...
| **Ценность** | Снижение разрозненности обучения, прозрачность ИПР и заявок, аналитика по компетенциям, поддержка решений за счёт ИИ-наставника и отчётности. |
...
|----------|----------------|-----------------|
| Сотрудник | `EmployeeShell` | Главная → кабинет, курсы, календарь, ИПР, настройки — линейная навигация боковым меню. |
